...
|---|---|---|---|---|---|---|
| 1 | `buoi01_moian_vitquay` | 她请我们吃了北京烤鸭 | mời ăn, món BK, nhờ vả | 语气助词"吧"(2) · "是…的"句 · 请/让/叫 | L22 | ⏳ |
...
| 9 | `buoi09_douong` | 我去买杯奶茶 | đồ uống, mua sắm **+ hỏi giá/so sánh giá** | 时量补语(1) · 主谓谓语句 · 选择问句 | L30 · L16 | ⏳ |
| 10 | `buoi10_thicu` | 就要考试了 | thi cử, học tập **+ đặt lịch hẹn**⚠️ | 要/快/快要/就要…了 · 着(1)(2) | — | ⏳ |
...
Chưa build buổi nào (⏳ tất cả). Đang ở cuối Phase 0 (Task 0.1 ✅, Task 0.2 ✅, Task 0.3 — file này).
