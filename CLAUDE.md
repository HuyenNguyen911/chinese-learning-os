...
8. **Feature branch theo khóa học (`feat/hskN-full-course`) tách khỏi `main` và KHÔNG
   ...
   **Ngoại lệ HSK2 (từ 2026-08-12) và HSK1 (từ 2026-09-08):** cả hai đã build THẲNG
   trên `main` (không còn nhánh riêng) — theo yêu cầu user vì nhánh/worktree riêng gây
   rối khi xem trên VS Code. `feat/hsk1-full-course` còn tồn tại trên git nhưng đã lỗi
