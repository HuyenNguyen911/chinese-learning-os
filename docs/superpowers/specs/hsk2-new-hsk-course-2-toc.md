# New HSK Course 2 (新HSK教程2) — Mục lục thật (trích từ sách)

**Nguồn:** `raw/New HSK Course 2.pdf` (164 trang, có text layer) — tải free từ cdn.baulchino.com (referer baulchino.com), user tìm chưa ra bản free (otextbook thu phí). Bìa = 西安钟楼夜景 (khớp bìa user gửi).
**Xuất bản:** 外语教学与研究出版社 (FLTRP), 2026-02 第1版. **ISBN** 978-7-5213-6804-8. **主编** 郭风岚; 副主编 黄蕾·解妮妮; 编者 王磊·黄蕾·于淼.
**Thông số (使用说明 p9):** 15 课 · từ vựng khớp 大纲 **200 từ (略有扩展)** · **45 điểm ngữ pháp (语言点)** · đối tượng đã học 30–36 tiết / ~300 từ · 2–3 tiết/bài.
**Cấu trúc mỗi bài:** 目标 (mục tiêu) · 热身 (khởi động: ghép từ-tranh) · 课文 (**4 bài/khoá: 3 hội thoại + 1 tự sự**) · 小语讲堂 (giảng+luyện ngữ pháp) · 综合练习 · 课堂活动 · 小语的彩蛋 (9 hộp văn hoá) · 学习小结 (mỗi 3 bài).
**Bối cảnh:** kịch tình huống (情景剧) 2 tuyến — hải ngoại + Trung Quốc, nhân vật xuyên suốt: AI 小语, 王一飞 (GV Hán ngữ hải ngoại), 白家月/安妮/陈天中/李文 (SV), 王一雪/刘明/刘小雪 (gia đình ở Bắc Kinh), 杨同乐.
**词汇表 (danh sách từ):** trang **141**. **词性对照表** trước đó. → Task 0.1 trích 200 từ + 45 ngữ pháp từ đây.
...
## Hệ quả cho spec
Syllabus 16-buổi tôi thiết kế trước (theo chuẩn 3.0 tổng quát) **khác** thứ tự/chủ đề sách thật. Để "đúng chuẩn" → **viết lại §4/§5 spec bám 15 bài này** (buổi ≈ bài; cân nhắc +1 capstone và/hoặc +2 ôn theo nhịp 学习小结 mỗi 3 bài của sách).
